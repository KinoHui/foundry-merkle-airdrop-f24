...
contract Interact is Script {
    ...
    function claimAirdrop(address merkleAirdrop) public {
        ...
        vm.startBroadcast();
        MerkleAirdrop(merkleAirdrop).claim(CLAIMING_ADDRESS, AMOUNT_CLAIM, proof, v, r, s);
        vm.stopBroadcast();
    }

    function run() external {
        address recentContract = DevOpsTools.get_most_recent_deployment("MerkleAirdrop", block.chainid);
        claimAirdrop(recentContract);
    }
}
